...
<figure>
  <img src= "https://raw.githubusercontent.com/2KAbhishek/phonepy/main/images/screenshot.jpg" alt="phonepy Demo" style="width:100%">
  <br/>
  <figcaption>phonepy screenshot</figcaption>
</figure>
...
phonepy is a `<utility/tool/feature>` that allows `<insert_target_audience>` to do `<action/task_it_does>`.

## Inspiration

phonepy was inspired by `<reason/idea>`.
...
To install phonepy, follow these steps:
...
phonepy was built using `<tech/library>`

## Challenges faced

While building phonepy the main challenges were `<issue/difficulty>`

## What I learned

While building phonepy I `<learned/accomplished>` about `<learning/accomplishment>`
